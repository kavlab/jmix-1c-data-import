package ru.kavlab.dataimportaddon;
...
public class DiaConfiguration {
    ...
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("ru.kavlab.dataimportaddon"));
    ...
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("ru.kavlab.dataimportaddon"));
        return actions;
    }
}
